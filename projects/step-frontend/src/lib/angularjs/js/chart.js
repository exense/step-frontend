...
(function () {
  ...
  function createChart(type, scope, elem) {
    ...
    var chart = new Chart(ctx, { type: type, data: data, options: scope.handle.options || {} });
  ...
  function isEmpty(value) {
    return (
      !value || (Array.isArray(value) && !value.length) || (typeof value === 'object' && !Object.keys(value).length)
    );
  }
})();
