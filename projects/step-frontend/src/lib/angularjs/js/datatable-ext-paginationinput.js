...
$.fn.dataTableExt.oPagination.ellipsesInput = {
  ...
  fnInit: function (oSettings, nPager, fnCallbackDraw) {
    ...
    var oPrevious = $(
        '<li class="paginate_button ' +
          oClasses.sPagePreviousContainer +
          '"><a class="' +
      ...
      oInput = $(
        '<li class="' +
          oClasses.sInputWrapper +
          '"><span><input style="margin-top:-2px; margin-bottom:-2px;width: 30px;height:24px;" type="text" class="' +
          oClasses.sPageInput +
          '"></input> <span>of</span> <span class="' +
          oClasses.sPageTotal +
          '">' +
          oSettings._iTotalPages +
          '</span></span></li>'
      ),
      oNext = $(
        '<li class="paginate_button ' +
          oClasses.sPageNextContainer +
          '"><a class="' +
          oClasses.sPageButton +
          ' ' +
          oClasses.sPageNext +
  ...
  fnUpdate: function (oSettings, fnCallbackDraw) {
    ...
    var i,
      ...
      oInputWrapper = $('.' + oClasses.sInputWrapper, tableWrapper),
      oInput = $('.' + oClasses.sPageInput, tableWrapper),
      oPageTotal = $('.' + oClasses.sPageTotal, tableWrapper);
    ...
    for (i = oSettings._iFirstPage; i <= oSettings._iLastPage; i++) {
      oNumber = $(
        '<a class="' + oClasses.sPageButton + ' ' + oClasses.sPageNumber + '">' + oSettings.fnFormatNumber(i) + '</a>'
      );
