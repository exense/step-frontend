 ...
 *******************************************************************************/
angular
  .module('reportTree', ['step', 'artefacts'])
        ...
        treeDiv.jstree({
          core: {
            ...
            data: function (obj, cb) {
              ...
              $http
                .get('rest/controller/reportnode/' + id + '/children?skip=' + skip + '&limit=' + limit)
                .then(function (response) {
                  ...
                  var children = _.map(nodes, function (node) {
                    ...
                    var cssClass = node.resolvedArtefact
                      ? artefactTypes.getIcon(node.resolvedArtefact._class)
                      : artefactTypes.getDefaultIcon();
                    return {
                      id: node.id,
                      text: node.name,
                      children: true,
                      icon: 'glyphicon ' + cssClass + ' status-' + node.status,
                    };
                  });
