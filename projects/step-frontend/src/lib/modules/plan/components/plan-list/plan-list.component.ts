...
export class PlanListComponent implements DialogParentService, SchedulerInvokerService {
  ...
  /**
   * Plans generated by the AI agent carry the origin marker of their YAML descriptor in their custom fields.
   */
  isAiGenerated(plan: Plan): boolean {
    return plan.customFields?.['origin'] === 'ai';
  }
