...
import { DashletRegistryService, EntityRegistry, SettingBtnComponent, StepCoreModule } from '@exense/step-core';
...
export class AdminModule {
  constructor(_entityRegistry: EntityRegistry, _dashletRegistry: DashletRegistryService) {
    ...
    _dashletRegistry.registerDashlet('settings-btn', SettingBtnComponent);
  }
}
