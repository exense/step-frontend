...
const registerInfoBanners = (): void => {
  const _infoBannerService = inject(InfoBannerService);
};

const registerEntityTables = (): void => {
...
const registerBulkOperations = (): void => inject(AutomationPackagesBulkOperationsRegisterService).register();
