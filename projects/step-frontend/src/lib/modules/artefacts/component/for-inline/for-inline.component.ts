  ...
  private _itemsBuilder = inject(ArtefactInlineItemsBuilderService)
    ...
    .extractArtefactItems((artefact) => {
      ...
      const source: ArtefactInlineItemSource = [
        { label: undefined, value: artefact.dataSource!.start, hideColon: true, margin: '0' },
        { label: 'to', value: artefact.dataSource!.end, hideColon: true, margin: '0' },
        { label: 'by', value: artefact.dataSource!.inc, hideColon: true, margin: '0' },
