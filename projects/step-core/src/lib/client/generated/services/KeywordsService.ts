...
export class KeywordsService {
     ...
     * @throws ApiError
     */
    public getTokenHandle(
        requestBody?: GetTokenHandleParameter,
     ...
     * @throws ApiError
     */
    public lookupCallFunction(
        requestBody?: CallFunction,
    ): Observable<Function> {
        return this.httpRequest.request({
            method: 'POST',
