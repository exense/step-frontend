...
export class SchedulerService {
     ...
     * @throws ApiError
     */
    public enableAllExecutionTasksSchedule(
        enabled?: boolean,
    ): Observable<any> {
        return this.httpRequest.request({
            method: 'PUT',
    ...
    public getExecutionTask(
        id: string,
    ): Observable<ExecutiontTaskParameters> {
        return this.httpRequest.request({
            method: 'GET',
     ...
     */
    public schedule(
        requestBody?: ExecutiontTaskParameters,
    ): Observable<any> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/scheduler/task',
