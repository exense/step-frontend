...
import { BulkSelLabelComponent } from '../bulk-sel-label/bulk-sel-label.component';
import { MatCheckbox } from '@angular/material/checkbox';

@Component({
  selector: 'step-bulk-sel',
  imports: [StepBasicsModule, BulkSelLabelComponent],
  templateUrl: './bulk-sel.component.html',
  styleUrl: './bulk-sel.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class BulkSelComponent<KEY, ENTITY> {
