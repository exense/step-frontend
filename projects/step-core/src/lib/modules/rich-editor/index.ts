...
import { RichEditorChangeStatusComponent } from './components/rich-editor-change-status/rich-editor-change-status.component';
...
export * from './components/rich-editor-change-status/rich-editor-change-status.component';
...
export const RICH_EDITOR_EXPORTS = [
  RichEditorComponent,
  RichEditorDialogComponent,
  RichEditorSettingsBarComponent,
  RichEditorChangeStatusComponent,
];
