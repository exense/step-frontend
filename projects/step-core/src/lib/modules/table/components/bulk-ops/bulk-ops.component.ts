...
@Component({
  selector: 'step-bulk-ops',
  imports: [EntitiesSelectionModule, StepBasicsModule, AUTH_EXPORTS],
  templateUrl: './bulk-ops.component.html',
  styleUrl: './bulk-ops.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class BulkOpsComponent<KEY, ENTITY> {
